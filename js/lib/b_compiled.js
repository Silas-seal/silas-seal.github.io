  ...
  constructor(props) {
    ...
    this.state = {
      reengineering: {
        ...
        applink: 'http://20.62.2.131:8080/Innerveilministries',
      ...
      scoasoft: {
        appname: 'Scoasoft',
        applink: 'http://20.62.2.131:8080/Reost_Inc/scoasoft.html',
      ...
      jeumxtool: {
        appname: 'JeumxTool',
        applink: 'http://20.62.2.131:8080/JeumxWeb',
      ...
      rswebapp: {
        appname: 'Reost, Inc webapp',
        applink: 'https://reost-co.github.io',
