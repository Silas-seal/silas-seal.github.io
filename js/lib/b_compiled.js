//Sat Sep 03 2022 12:19:29 GMT+0300 (East Africa Time)
//Including top file
//Just sampling up
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      scoasoft: {
        ...
        mycontr: ['Analysing and designing the system.', 'Building app GUI Nodes and Panels.', 'Coding and testing of api components.', 'Integration and System testing.', 'Database administration.', 'Writing reusable frontend React Componets.', 'Collaboration on backend programming using Node.js.'],
      ...
      jeumxtool: {
        ...
        mycontr: ['Structured and designed specifications.', 'Developed the components ' + 'and assembled a single tool.', 'Tested and debugged the software.', 'Developed a website for my developed tool.', 'Deployed a functional tool.'],
      ...
      rswebapp: {
        ...
        appdesc: 'On-going revision and rebuilding of our web application here at Remote Station. ' + 'The Objective is to simply the app, make it lightweight and more responsive using ' + 'React on frontend and Python (flask) on the backend.',
        mycontr: ['Writing reusable React Components.', 'Coding and testing features in Python.', 'Implementing web services with flask.', 'Database administration.', 'Security monitoring.'],
